...
public class AddCarScreen {
    ...
    public void display() {
        ...
        String brand = Console.readText("Enter the brand: ", Patterns.carBrandPattern, "Invalid format or too many characters. Please try again.");
        String model = Console.readText("Enter the model: ", Patterns.carModelPattern, "Invalid format or too many characters. Please try again.");
        String type = Console.readText("Enter the type: ", Patterns.carTypePattern, "Invalid format or too many characters. Please try again.");
        String color = Console.readText("Enter the color: ", Patterns.carColorPattern, "Invalid format or too many characters. Please try again.");
